...
// so the two platform copies must not drift. Their theme loaders also need a
// tiny CLI; append it here instead of hand-editing generated platform copies.
const IMAGE_METADATA_CLI = `
...
function compileImageMetadataCli(source) {
...
const outputs = [
  ...
  {
    content: compileImageMetadataCli(sourceImageMetadata),
    paths: [
