...
- **Continuous wallpaper** — Landscape, square, and portrait images can span the full window and sidebar while adaptive focus and safe-area treatment keep native content readable.
- **Swappable art** — Drop in a UI-free image you like and it becomes your theme.
- **Timed rotation** — Cycle through the local image folder in filename order; the default one-minute interval is configurable from the menu bar or tray.
