...
The menu-bar app also provides **自动换图**. It cycles supported files in
`~/Library/Application Support/CodexDreamSkinStudio/images/` by filename,
defaults to 60 seconds, and allows a custom interval of at least 10 seconds.
Pausing or restoring the skin stops rotation.
